    ...
    <>
      <div className="grid grid-cols-3 justify-items-center md:grid-cols-6">
        <div className="stat">
          ...
          <div
            className={generatePriceColors(previousHourPrice) + " stat-value"}
          >
            {previousHourPrice}
          </div>
        </div>
        <div className="stat">
          ...
          <div
            className={generatePriceColors(currentHourPrice) + " stat-value"}
          >
            {currentHourPrice}
          </div>
        </div>
        <div className="stat">
          ...
          <div className={generatePriceColors(nextHourPrice) + " stat-value"}>
            {nextHourPrice}
          </div>
        </div>
        ...
        <div className="stat">
          ...
          {lowestPricedHour ? (
            <>
              <div
                className={
                  generatePriceColors(lowestPricedHour.priceString) +
                  " stat-value mt-4"
                }
              >
        ...
        <div className="stat">
          ...
          {highestPricedHour ? (
            <>
              <div
                className={
                  generatePriceColors(highestPricedHour.priceString) +
                  " stat-value mt-4"
                }
              >
        ...
        <div className="stat">
          ...
          <div
            className={generatePriceColors(averageHourPrice) + " stat-value"}
          >
            {averageHourPrice}
          </div>
        </div>
